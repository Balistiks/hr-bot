...
async def get_data_user_keyboard(tg_id: int):
    ...
    markup.inline_keyboard.append([InlineKeyboardButton(text=f'Статус: {user_data['status']}', callback_data='#')])
    markup.inline_keyboard.append([
        InlineKeyboardButton(text='Дозвон' if user_data['status'] == 'недозвон' else 'Недозвон',
                             callback_data='status-окончил курс' if user_data['status'] == 'недозвон' else 'status-недозвон'),
